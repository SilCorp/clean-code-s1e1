...
var addButton=document.querySelector(".add-element__btn");//first button
var incompleteTaskHolder=document.querySelector(".tasks-list_uncompleted");//ul of #incompleteTasks
...
var editTask=function(){
    ...
    //toggle .tasks-list__item_edit on the parent.
...
//select ListItems children
    var checkBox=taskListItem.querySelector(".checkbox-input");
